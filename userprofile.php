...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-3" style="background-color:whitesmoke;height: 580px;position: fixed;margin-left: 10px;box-shadow:20px 20px 50px 10px lightblue inset ">
            ...
            <div style="margin-top: 18px ">
                <a href="#" class="active" Style="font-family: sofia;font-size: 18px;text-decoration: none"><img src="img/contact.svg" style="height: 25px;width: 25px;margin-right:10px;"/>Phone: 01750358721</a>
            </div>


            <div style="margin-top: 10px ">
                <a href="#" class="active" Style="font-family: sofia;font-size: 18px;text-decoration: none"><img src="img/256px-Email_Shiny_Icon.svg.png" style="height: 30px;width: 30px;margin-right:10px;"/>Email: sakibshahriar@yahoo.com</a>
            </div>
            <div style="margin-top: 10px ">
                <a href="#" class="active" Style="font-family: sofia;font-size: 16px;text-decoration: none"><img src="img/github.png" style="height: 30px;width: 30px;margin-right:10px;"/>Github: https://github.com/sk138</a>
            </div>
            <div style="margin-top: 10px ">
        ...
        <div class="col-lg-12" style="border: 1px solid black">
            <div class="col-lg-7" style="margin-top:10px;padding-bottom: 10px ">
                <div style="margin: 20px 0px 10px 10px;">
                    <a href="ask.php" class="active" Style="font-family: sofia;font-size: 40px;text-decoration: none; "><img src="img/user.ico" style="height: 150px;width: 150px;margin-right:10px;"/><?php echo $user_name;?></a>
                </div>
                ...
                <div style="margin: 30px 10px 0px 10px;">
                    ...
                    $sql = "select * from following where following_user_name='$user_name' and user_name='$un'";
                    $rst = $db->query($sql);
                    $rs = $rst->fetch_assoc();
                    if($rs){
                    ?>
                    <button id="btnfollow" onclick="func()" type="button" class="btn" style="width:22%">Following</button>
                    <?php } else{ ?>
                    <button id="btnfollow" onclick="func()" type="button" class="btn" style="width:22%">Follow</button>
                    <?php } ?>
                    <button type="button" class="btn" style="width:22%">Message</button>
                </div>

          	</div>
          	<div class="col-lg-4" style="margin-top:10px;padding-bottom: 10px ">
                <div style="margin: 50px 0px 10px 50px;">
                    <a href="ask.php" class="active" Style="font-family: sofia;font-size: 20px;text-decoration: none; "><img src="img/follower.png" style="height: 50px;width: 50px;margin-right:10px;"/><?php echo $follower;?> Follower</a>
                </div>
                <div style="margin: 50px 0px 10px 50px;">
                    <a href="ask.php" class="active" Style="font-family: sofia;font-size: 20px;text-decoration: none; "><img src="img/following.png" style="height: 50px;width: 50px;margin-right:10px;"/><?php echo $following;?> Following</a>
                </div>
            ...
            <div class="col-lg-12" style="border: 1px solid black;margin-top: 15px">
                ...
                <div class="col-lg-12" style="border-top: 2px solid black; margin: 3px 0px 5px 0px">
                    <ul class="nav navbar-nav" style="float: left">
                        ...
                        <li>
                            <button type="button" class="btn btn-link" style="text-decoration: none;margin-left: 214px;"><img src="img/saved.svg" style="height: 34px;width: 34px;float: left;margin-left: 179px;cursor: pointer;"/></button>
